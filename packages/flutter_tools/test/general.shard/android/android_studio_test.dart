...
void main() {
  ...
  group('pluginsPath on Mac', () {
    ...
    testUsingContext('Can discover Android Studio >=4.1 location on Mac', () {
      ...
      when(plistUtils.parseFile(plistFilePath))
          .thenReturn(macStudioInfoPlist4_1);
    ...
    testUsingContext(
      ...
      when(plistUtils.parseFile(jetbrainsPlistFilePath))
          .thenReturn(jetbrainsInfoPlist);
      ...
      when(plistUtils.parseFile(studioPlistFilePath))
          .thenReturn(macStudioInfoPlist);
  ...
  testUsingContext('Can discover Android Studio 4.1 location on Windows', () {
    windowsFileSystem.file(
        'C:\\Users\\Dash\\AppData\\Local\\Google\\AndroidStudio4.1\\.home')
      ..createSync(recursive: true)
